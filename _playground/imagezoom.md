...
<head>
	<meta charset="UTF-8">
	<title>Instagram Style Press-n-Hold to Zoom</title>
	...
	<link href='https://cdn.jsdelivr.net/npm/evil-icons@1.9.0/assets/evil-icons.min.css' rel='stylesheet'>
...
<body translate="no">
	<div class="container d-flex flex-wrap body-wrapper">
		<main aria-label="Main Content Area" class="col-12 order-lg-2" role="main">
			...
			<p>Click and hold on the card image to zoom in.</p>
			<div class="row mb-3">
				<div class="col-md-4">
					<div class="card">
