/* TP Build time - 4.9.11.0 | 04/16/2021@10:03:05 */
"use strict";
"use strict";
...
!function (e, t) {
  ...
  var E = o(["a", "abbr", "acronym", "address", "area", "article", "aside", "audio", "b", "bdi", "bdo", "big", "blink", "blockquote", "body", "br", "button", "canvas", "caption", "center", "cite", "code", "col", "colgroup", "content", "data", "datalist", "dd", "decorator", "del", "details", "dfn", "dir", "div", "dl", "dt", "element", "em", "fieldset", "figcaption", "figure", "font", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hgroup", "hr", "html", "i", "img", "input", "ins", "kbd", "label", "legend", "li", "main", "map", "mark", "marquee", "menu", "menuitem", "meter", "nav", "nobr", "ol", "optgroup", "option", "output", "p", "picture", "pre", "progress", "q", "rp", "rt", "ruby", "s", "samp", "section", "select", "shadow", "small", "source", "spacer", "span", "strike", "strong", "style", "sub", "summary", "sup", "table", "tbody", "td", "template", "textarea", "tfoot", "th", "thead", "time", "tr", "track", "tt", "u", "ul", "var", "video", "wbr"]),
      ...
      F = o(["accent", "accentunder", "align", "bevelled", "close", "columnsalign", "columnlines", "columnspan", "denomalign", "depth", "dir", "display", "displaystyle", "encoding", "fence", "frame", "height", "href", "id", "largeop", "length", "linethickness", "lspace", "lquote", "mathbackground", "mathcolor", "mathsize", "mathvariant", "maxsize", "minsize", "movablelimits", "notation", "numalign", "open", "rowalign", "rowlines", "rowspacing", "rowspan", "rspace", "rquote", "scriptlevel", "scriptminsize", "scriptsizemultiplier", "selection", "separator", "separators", "stretchy", "subscriptshift", "supscriptshift", "symmetric", "voffset", "width", "xmlns"]),
      ...
      P = i(/^(?:\w+script|data):/i),
      G = i(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205f\u3000]/g),
      W = "function" == typeof Symbol && "symbol" == _typeof(Symbol.iterator) ? function (e) {
    return _typeof(e);
  } : function (e) {
  ...
  return function e() {
    ...
    var ue = C,
        ...
        ge = j,
        he = null,
        ve = L({}, [].concat(B(E), B(M), B(D), B(N), B(R))),
        be = null,
        Te = L({}, [].concat(B(O), B(w), B(F), B(H))),
        Ae = null,
        xe = null,
        Se = !0,
        ke = !0,
    ...
    var $e = function $e(e) {
      ...
      if (!he[r] || Ae[r]) {
        if (Ce && !Ue[r] && "function" == typeof e.insertAdjacentHTML) try {
          var o = e.innerHTML;
      ...
      if (ke && T(fe, t)) ;else if (Se && T(pe, t)) ;else {
        if (!be[t] || xe[t]) return !1;
        if (Ge[t]) ;else if (T(ge, h(n, ye, ""))) ;else if ("src" !== t && "xlink:href" !== t && "href" !== t || "script" === e || 0 !== v(n, "data:") || !je[e]) {
          if (Le && !T(me, h(n, ye, ""))) ;else if (n) return !1;
        } else ;
      }
      return !0;
    },
      ...
      if (c) {
        ...
        for (l = c.length; l--;) {
          ...
          if (o = b(t.value), i = y(g), s.attrName = i, s.attrValue = o, s.keepAttr = !0, s.forceKeepAttr = void 0, Ze("uponSanitizeAttribute", e, s), o = s.attrValue, !s.forceKeepAttr) {
            if ("name" === i && "IMG" === e.nodeName && c.id) a = c.id, c = m(c, []), Ye("id", e), Ye(g, e), u(c, a) > l && e.setAttribute("id", a.value);else {
              if ("INPUT" === e.nodeName && "type" === i && "file" === o && s.keepAttr && (be[i] || !xe[i])) continue;
              "id" === g && e.setAttribute(g, ""), Ye(g, e);
            }
            if (s.keepAttr) if (_e && T(/\/>/i, o)) Ye(g, e);else if (T(/svg|math/i, e.namespaceURI) && T(A("</(" + d(r(Ue), "|") + ")", "i"), o)) Ye(g, e);else {
      ...
      for (Ze("beforeSanitizeShadowDOM", t, null); n = r.nextNode();) {
        Ze("uponSanitizeShadowNode", n, null), et(n) || (n.content instanceof c && e(n.content), nt(n));
      }
    ...
    return n.sanitize = function (e, r) {
      ...
      if (De || Ke(r), n.removed = [], "string" == typeof e && (ze = !1), ze) ;else if (e instanceof k) 1 === (a = (o = Xe("\x3c!--\x3e")).ownerDocument.importNode(e, !0)).nodeType && "BODY" === a.nodeName || "HTML" === a.nodeName ? o = a : o.appendChild(a);else {
        if (!Re && !Ee && !Me && -1 === e.indexOf("<")) return te && Fe ? te.createHTML(e) : e;
        if (!(o = Xe(e))) return Re ? null : ne;
      }
      o && Ne && Ve(o.firstChild);

      for (var d = $e(ze ? e : o); l = d.nextNode();) {
        3 === l.nodeType && l === s || et(l) || (l.content instanceof c && rt(l.content), nt(l), s = l);
      }

      if (s = null, ze) return e;

      if (Re) {
        if (Oe) for (u = le.call(o.ownerDocument); o.firstChild;) {
      ...
      return Ee && (f = h(f, ue, " "), f = h(f, de, " ")), te && Fe ? te.createHTML(f) : f;
...
(function (window, document, undefined) {
  ...
  window.CDC.Common = window.CDC.Common || function () {
    ...
    objCommon.cleanUrl = function (targetURL, blankValue) {
      ...
      sanitizedUrl = String(targetURL).replace(/[^\x20-\x7E]/gmi, '').replace(/[^-A-Za-z0-9+&@#/%?=~_|!:,.;\(\)]+/g, '').trim();
     ...
     * @param {string} stylesheetPath Path to CSS file
     * @param {string} media          Media to apply styles to, default 'print,screen'
     */


    objCommon.loadCss = function (stylesheetPath, media) {
    ...
    objCommon.cdcUrl = function (targetURL) {
      ...
      return 'cdc.gov' === host || RegExp('\.cdc\.gov$').test(host);
     ...
     * @returns {{val: val, save: save, clear: clear}}
     */
  ...
  window.CDC.getParam = window.CDC.Common.getParam;
  window.CDC.open = window.CDC.Common.open;
  window.CDC.parseUrl = window.CDC.Common.parseUrl;
  window.CDC.cleanUrl = window.CDC.Common.cleanUrl;
  window.CDC.cleanHTML = window.CDC.Common.cleanHTML;
  window.CDC.cleanAttr = window.CDC.Common.cleanAttr; // finally load DOMPurify script if it's not available

  if ('function' !== typeof window.DOMPurify) {
    window.CDC.Common.loadScript('https://www.cdc.gov/TemplatePackage/contrib/libs/dompurify/purify.min.js');
  }
})(window, document);
"use strict";
...
(function (window, document, undefined) {
  ...
  window.CDC.Common.getMetricsHandler = function () {
    ...
    commonMetricsVersion = '4.9.11'; // GRAB SHORTCUT FOR EXISTING CDC.WIDGET.COMMON
  ...
  CDCPlugin.prototype = {
    ...
    updateSocialLinks: function updateSocialLinks(url, title) {
      ...
      if ($(".page-share-twitter").length) {
        ...
        $(".page-share-twitter").attr("href", encodeURI(socialUrl));
      ...
      if ($(".page-share-linkedin").length) {
        ...
        $(".page-share-linkedin").attr("href", encodeURI(socialUrl));
  ...
  CDCPlugin.prototype = {
    ...
    parseFacebook: function parseFacebook($parent, feed, feedOptions) {
      ...
      var _urlExpression = /(\b(https?|ftp):\/\/[-A-Z0-9+&@#\/%?=~_|!:,.;]*[-A-Z0-9+&@#\/%=~_|])/gim,
          _mentionExpression = /(?:^|[^a-zA-Z0-9_ï¼ !@#$%&*])(?:(?:@|ï¼ )(?!\/))([a-zA-Z0-9/_]{1,15})(?:\b(?!@|ï¼ )|$)/gim,
          _regex,
...
CDC.Carousel = function (window, $) {
  ...
  var buttons = {
    play: '<img role="button" class="playbtn" aria-label="play video button" src="/TemplatePackage/4.0/assets/imgs/play.png" />',
    prev: '<img role="button" class="slider-prev" src="/TemplatePackage/4.0/assets/imgs/left.png" aria-label="previous slide button">',
    next: '<img role="button" src="/TemplatePackage/4.0/assets/imgs/right.png" aria-label="next slide button" class="slider-next">'
  };
  ...
  function slickInit(target, settings) {
    ...
    if (config.enableAria) {
      ...
      if ('' === config.ariaLabel && '' === config.ariaLabelTarget) {
...
CDC.Datatable = CDC.Datatable || function ($dom) {
  ...
  var filetype = file.toLowerCase().trim().replace(/^.*\./, '');
  ...
  options.dom = "<'row'<'col-sm-12 col-md-6'l><'col-sm-12 col-md-6'<'cdc-custom-filter'>f>>" + "<'row'<'col-sm-12'tr>>" + "<'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7'p>>"; // show pagination at top and bottom?
  ...
  function init() {
    switch (filetype) {
      case 'csv':
        ...
        CDC.Common.loadScript('/TemplatePackage/contrib/libs/papa-parse/4.1.2/papaparse.js', function () {
          loadCSV(file);
        });
        break;
...
CDC.Datatables = CDC.Datatables || function ($) {
  ...
  function init() {
    ...
    $('.cdc-datatable-module').each(function () {
      datatables.push(new CDC.Datatable($(this)));
    });
  }
...
(function ($, window, document, undefined) {
  ...
  window.CDC.tp4.interactionMetrics = window.CDC.tp4.interactionMetrics || function () {
          ...
          if ('function' === typeof s.tl) {
            ...
            if ('a' === element.prop('tagName').toLowerCase() && navigate) {
              ...
              if (navigate) {
                ...
                mTricsCall(s, label, interaction, navigate);
              } else {
                s.tl(true, 'o', label);
                mTricsCall(s, label, interaction, navigate);
                result = false;
    ...
    var mTricsCall = function mTricsCall(s, label, interaction, navigate) {
      var imageURL = encodeURIComponent(window.location.href.split('#')[0].split('?')[0]);
      var mTricsPageName = s.pageName ? s.pageName : document.title;
      var imagePageName = encodeURIComponent(mTricsPageName);
      var imageDate = new Date().getTime().toString();
      var imageTrigger = encodeURIComponent('ci-' + label + ': ' + interaction);
      var mtricsCall = 'https://mtrics.cdc.gov/cdcgov/1.0.0/s.gif?'; // mtricsCall += 'AQB=1';
      // mtricsCall += '&ndh=1';
      // mtricsCall += '&pf=1';
      // mtricsCall += '&t=1%2F3%2F2021%2011%3A58%3A43%204%20240'; //default adobe - time
      // mtricsCall += '&mid=80879625012097012492518777771485249390'; //default adobe - experience cloud id
      // mtricsCall += '&aamlh=7';  //default adobe - audience manager regional data
      // mtricsCall += '&ce=UTF-8'; //timezone
      // mtricsCall += '&g=' + imageURL; //default adobe - page url
      // mtricsCall += '&cc=USD'; //default adobe - currency code
      // mtricsCall += '&ch=CDC%20Top%20Tier'; //default adobe - channel
      // mtricsCall += '&events=event56';  //default adobe - events

      mtricsCall += '&_=' + imageDate; //time

      mtricsCall += '&pageName=' + imagePageName; //pageName

      mtricsCall += '&c2=' + imageURL; //page address/url

      mtricsCall += '&c31=' + imageURL; //page url

      mtricsCall += '&c40=' + imageTrigger; //interaction call

      mtricsCall += '&c46=' + imageURL; //page url
      // mtricsCall += '&c49=xxl'; //viewport
      // mtricsCall += '&pe=lnk_o'; //default adobe - type of link
      // mtricsCall += '&pev2=left-nav-anchor-child'; //default adobe - name of link
      // mtricsCall += '&s=1920x1080'; //default adobe - resolution
      // mtricsCall += '&c=24'; //default adobe - color depth
      // mtricsCall += '&j=1.6'; //default adobe - Javascript version
      // mtricsCall += '&v=N'; //default adobe - whether the visitor has Java enabled
      // mtricsCall += '&k=Y'; //default adobe - cookies enabled/disabled
      // mtricsCall += '&bw=1709'; //default adobe - browser height
      // mtricsCall += '&bh=827'; //default adobe - browser width
      // mtricsCall += '&mcorgid=66818A1A54FA2E890A4C98A6%40AdobeOrg';
      // mtricsCall += '&lrt=3';
      // mtricsCall += '&AQE=1';
      ...
      $.ajax({
        ...
        success: function success(results) {
          console.log('mtrics-akami-capture: ' + label + ' - ' + interaction);
        },
        error: function error(_error) {
          console.log('Mtrics Akami call failure.' + JSON.stringify(_error));
        }
      });
    };
...
//       var leftOrBottom = -1 < $.inArray(CDC.tp4["public"].getViewport(), [1, 2, 3]) ? 'bottom' : 'left';
//       $(this).trigger('metrics-capture', ['meganav-' + leftOrBottom + 'nav-item', 'click']);
...
//     $('.cdc-2020 nav .tp-nav-main a').on('click', function () {
//       var level = $(this).parent('.list-group-item').attr('data-level');
//       var isIcon = $(this).hasClass('nav-expandcollapse');
//       var leftOrBottom = -1 < $.inArray(CDC.tp4["public"].getViewport(), [1, 2, 3]) ? 'bottom' : 'left'; //IF is an icon
...
//         undernav = '<li class="list-under-item list-item-first"><a href="https://www.cdc.gov/coronavirus/2019-ncov/index.html"><span class="x16 fill-p cdc-icon-home-lg-light"></span>COVID-19 Home</a></li>' + '<li class="list-under-item"><a href="https://www.cdc.gov/coronavirus/2019-ncov/your-health/index.html"><span class="x16 fill-p cdc-icon-user-light"></span>Your Health</a></li>' + '<li class="list-under-item"><a href="https://www.cdc.gov/coronavirus/2019-ncov/vaccines/index.html"><span class="x16 fill-p cdc-icon-band-aid-light" style="transform:rotate(45deg)"></span>Vaccines</a></li>' + '<li class="list-under-item"><a href="https://covid.cdc.gov/covid-data-tracker/#datatracker-home"><span class="x16 fill-p cdc-icon-chart-bar-light"></span>Cases &amp; Data</a></li>' + '<li class="list-under-item"><a href="https://www.cdc.gov/coronavirus/2019-ncov/community/index.html"><span class="x16 fill-p cdc-icon-building-light"></span>Work &amp; School</a></li>' + '<li class="list-under-item"><a href="https://www.cdc.gov/coronavirus/2019-nCoV/hcp/index.html"><span class="x16 fill-p cdc-icon-user-md-light"></span>Healthcare Workers</a></li>' + '<li class="list-under-item"><a href="https://www.cdc.gov/coronavirus/2019-nCoV/lab/index.html"><span class="x16 fill-p cdc-icon-vial-light"></span>Laboratories</a></li>' + '<li class="list-under-item"><a href="https://www.cdc.gov/coronavirus/2019-ncov/php/index.html"><span class="x16 fill-p cdc-icon-notes-medical-light"></span>Health Departments</a></li>' + '<li class="list-under-item"><a href="https://www.cdc.gov/coronavirus/2019-ncov/science/science-and-research.html"><span class="x16 fill-p cdc-icon-virus-light"></span>Science &amp; Research</a></li>' + '<li class="list-under-item list-item-last"><a href="https://www.cdc.gov/coronavirus/2019-ncov/more/index.html"><span class="x16 fill-p cdc-icon-ballot-check-light"></span>More Resources</a></li>',
...
//     }); //Set the height of the scrollable <nav> so that it does't expand beyond the bottom of the visible window.

//     var maxHeight = window.innerHeight - $('.site-title').offset().top - $('.site-title').height() - 2;
//     var currentHeight = $('#covid-nav-mobile').height();
...
//             top = ul[0].getBoundingClientRect().top; // newpos is where the child UL should appear, often a negative top position
...
//       e.preventDefault();
//       e.stopPropagation(); // show the parent
...
//       resetNewNav();
//     });
//     var position = $(window).scrollTop(); // position the top of the mobile nav on scroll/swipe
...
//       var newpos = position + stbm; // if we're at or near the very top, sticky hasn't positioned the title bar so remove any styling

//       if (61 >= position) {
//         $('#covid-nav-mobile').attr('style', '');
//       } else {
    ...
    buildMobileSectionNav = function buildMobileSectionNav(configSectionNav, $targetAnchor, callback) {
      ...
      if (config.mobileSectionNav.enabled) {
        ...
        if (!$injectPoint.length) {
          $injectPoint = $('.mobile-section-nav-menu ul', $mobileSectionNav);
        }
        ...
        $mobileSectionNav.find('.mobile-title').html(currentTitle); //check for if TP is out on WWWDEV 07-14-20

        if ($('html').hasClass('cdc-2020')) {
          var cdcMobileTitle = $('.cdc-2020-mobile-title');

          if (!cdcMobileTitle.length) {
            var $title = $('h1:first');
            $title.addClass('d-none d-lg-block');
            cdcMobileTitle = $('<div class="cdc-2020-mobile-title h1 open d-block d-lg-none d-print-none"></div>');
            $title.after(cdcMobileTitle);
          } // Update cdc 2020 style title bar


          cdcMobileTitle.html(currentTitle);
        } // create mask
...
CDC.Search = CDC.Search || function () {
  ...
  var config = {
    ...
    typeAheadLength: isIntranet ? 2 : 5,
    webHost: webHost,
