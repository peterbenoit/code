...
<div class="container">
	<div class="row">
		<div class="col">
			<span class="h3 d-block" id="sliderLabel">Slick Slider -  Video Slider Five Wide</span>
		</div>
	</div>
	...
	<div class="card">
		...
		<div aria-labelledby="accordion-4-card-3" class="collapse show" id="accordion-4-collapse-3" role="tabpanel">
			<div class="card-body">
				...
				<ol>
					<li>A video card slider, the same as the <a href="image-slider-five-wide.html">five wide image slider demo</a> with two exceptions:
						<ol>
